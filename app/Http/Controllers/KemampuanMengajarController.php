...
class KemampuanMengajarController extends Controller
{
    public function index()
    {
        $datas = SubKriteriaModel::with('kriteria')->where('kriteria_id', 3)->get();

        return view('sub_kriteria.kemampuan_mengajar', compact('datas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'nilai_min' => 'required|numeric|between:0,100|lt:nilai_max',
            'nilai_max' => 'required|numeric|between:0,100|gt:nilai_min',
