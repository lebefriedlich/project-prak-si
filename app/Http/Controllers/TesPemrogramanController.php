...
class TesPemrogramanController extends Controller
{
    public function index()
    {
        $datas = SubKriteriaModel::with('kriteria')->where('kriteria_id', 2)->get();

        return view('sub_kriteria.tes_pemrograman', compact('datas'));
    }
