...
@section('title', 'Data Sub Kriteria - Nilai Referensi')
@section('css')
    <style>
        th,
        td {
...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Data Sub Kriteria - Nilai Referensi</h4>
                        </div>
                        <div class="card-body">
                            <div class="d-flex justify-content-end mb-3">
                                <button class="btn btn-primary" data-toggle="modal" data-target="#TambahModal"><i
                                        class="bi bi-plus-circle"></i>
                                    Tambah Data Sub Kriteria - Nilai Referensi</button>
                            </div>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Hapus Data
                                                                    Sub Kriteria - Nilai Referensi</h5>
                                                            ...
                                                            <div class="modal-body text-left text-dark">Apakah anda yakin
                                                                menghapus
                                                                data Nilai Referensi tersebut?
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button class="btn btn-warning" type="button"
                                                                    data-dismiss="modal">Tidak</button>
                                                                <form
                                                                    action="{{ route('sub_kriteria.nilai_referensi.destroy', $data->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                ...
                                                <div class="modal fade" id="EditModal{{ $data->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form
                                                                action="{{ route('sub_kriteria.nilai_referensi.update', $data->id) }}"
                                                                method="POST">
                                                                @csrf
    ...
    <div class="modal fade" id="TambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Data Sub Kriteria - Nilai Referensi</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <form action="{{ route('sub_kriteria.nilai_referensi.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
