...
@section('title', 'Data Sub Kriteria - IPK')
@section('css')
    <style>
        th,
        td {
...
@section('content')
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-left text-dark">Apakah anda yakin
                                                                menghapus
                                                                data Sub Kriteria - IPK tersebut?
                                                            </div>
    ...
    <div class="modal fade" id="TambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Data Sub Kriteria - IPK</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <form action="{{ route('sub_kriteria.ipk.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
